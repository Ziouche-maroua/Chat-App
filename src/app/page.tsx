...
export default async function Home() {
	...
	return (
		<main className='flex h-screen flex-col items-center justify-center p-4 md:px-24 py-32 gap-4'>
			...
			{/* dotted background */}
       <div className='absolute top-0 z-[-2] h-screen w-screen dark:bg-[#000100] dark:bg-[radial-gradient(#4A4A4A_1px,#000100_1px)] dark:bg-[size:20px_20px] bg-[#C0C0C0] bg-[radial-gradient(#001400_1px,#C0C0C0_1px)] bg-[size:20px_20px]' aria-hidden='true' />
